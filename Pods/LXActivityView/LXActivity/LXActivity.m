...
#define SHAREBUTTON_INTERVAL_WIDTH              ([UIScreen mainScreen].bounds.size.width-3*50)/4
#define SHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        50
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               ([UIScreen mainScreen].bounds.size.width-3*50)/4
...
#define TITLE_INTERVAL_WIDTH                    ([UIScreen mainScreen].bounds.size.width-260)/2
...
#define BUTTON_INTERVAL_WIDTH                   ([UIScreen mainScreen].bounds.size.width-260)/2
